...
/*Selecionar os funcionários que trabalhem no departemento de filmes ou no departamento de roupas*/
SELECT DEPARTAMENTO, COUNT(*) FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'Roupas' OR DEPARTAMENTO = 'Filmes') GROUP BY DEPARTAMENTO;
/*No and o que tem menos vem depois do and*/
SELECT nome FROM funcionarios WHERE (departamento = 'Roupas' OR departamento = 'Filmes');


/* lista das funcionárias que trabalhem no departamento de filmes ou no departamento de lar*/
SELECT DEPARTAMENTO, COUNT(*) FROM FUNCIONARIOS WHERE (SEXO = 'Feminino') AND (DEPARTAMENTO = 'LAR' OR DEPARTAMENTO = 'Filmes') GROUP BY DEPARTAMENTO;
/*no or o que tem mais vem depois*/
...
/*Funcionários do sexo masculino que trabalhem no jardim*/
